...
public class MainLanguage extends Language{
    ...
    public MainLanguage() {
        ...
        myKey0.showCustomChakra = true ;
        myKey0.customChakraLayout = new String[] {"","", "", "", "\u0a09", "\u0a0a", "", "", "\u0a13", ""} ;
        ...
        myKey1.showCustomChakra = true ;
        myKey1.customChakraLayout = new String[] {"","\u0a06", "", "", "", "", "\u0a05\u0a47", "\u0a10", "\u0a05\u0a4b", "\u0a14"} ;
        ...
        myKey2.showCustomChakra = true ;
        myKey2.customChakraLayout = new String[] {"","", "\u0a07", "\u0a08", "", "", "\u0a0f", "\u0A72\u0a48", "", ""} ;
        ...
        myKey39.customChakraLayout = new String[] {"","\u0a3e", "\u0a3f", "\u0a40", "\u0a41", "\u0a42", "\u0a47", "\u0a48", "\u0a4b", "\u0a4c"} ;
