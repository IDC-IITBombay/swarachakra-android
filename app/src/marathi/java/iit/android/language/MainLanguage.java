...
public class MainLanguage extends Language{
	...
	public MainLanguage() {
		...
		myKey48.code = 49;
		myKey48.label = "\u0945" ;//a ki matra as in captain
		...
		myKey55.code = 56;
		myKey55.label = "\u0967" ;//devanagari digit one 
		...
		myKey56.code = 57;
		myKey56.label = "\u0968" ;//devanagari digit two
		...
		myKey57.code = 58;
		myKey57.label = "\u0969" ;//devanagari digit three
		...
		myKey61.code = 62;
		myKey61.label = "\u096A" ;//devanagari digit four
		...
		myKey62.code = 63;
		myKey62.label = "\u096B" ;//devanagari digit five
		...
		myKey63.code = 64;
		myKey63.label = "\u096C" ;//devanagari digit six
		...
		myKey67.code = 68;
		myKey67.label = "\u096D" ;//devanagari digit seven
		...
		myKey68.code = 69;
		myKey68.label = "\u096E" ;//devanagari digit eight
		...
		myKey69.code = 70;
		myKey69.label = "\u096F" ;//devanagari digit nine
		...
		myKey75.code = 76;
		myKey75.label = "\u0966" ;//devanagari digit zero
		...
		myKey88.code = 89;
		myKey88.label = "\u0931\u094d" ; //0950=om, now ra nukta halant
		...
		myKey106 .code = 107;
		myKey106 .label = "\u093E" ;//kana matra velanti chakra
		myKey106 .showChakra = true ;
		myKey106 .showCustomChakra = true ;
		myKey106 .customChakraLayout = new String[] {"\u094D", "\u093E", "\u093F", "\u0940", "\u0941", "\u0942", "\u0947", "\u0948", "\u094B", "\u094C"} ;
		...
		myKey107.code = 108;
		myKey107.label = "\u0943" ;//ru chakra
		myKey107.showChakra = true ;
		myKey107.showCustomChakra = true ;
		//myKey107.customChakraLayout = new String[] {"\u200C","\u093d","\u0946", "\u094a","\u090b","\u0944", "\u0960","\u0972","\u0911","\u200D"} ;
		//myKey107.customChakraLayout = new String[] {"zwj","\u090b","\u0944", "\u0960","\u0972","\u0911","\u093d","\u0946", "\u094a","nzwj"} ;
		myKey107.customChakraLayout = new String[] {"\u200C","\u090b","\u0944", "\u0960","\u0972","\u0911","\u093d","\u0946", "\u094a","\u200D"} ;
		...
		myKey108.code = 109;
		myKey108.label = "\u0905" ;//stand alone vowel chakra
		myKey108.showChakra = true ;
		myKey108.showCustomChakra = true ;
		myKey108.customChakraLayout = new String[] {"\u0905", "\u0906", "\u0907", "\u0908", "\u0909", "\u090A", "\u090F", "\u0910", "\u0913", "\u0914"} ;
		...
		myKey121 .code = 122;
		myKey121 .label = "\u0949" ;//o ki matra as in doctor
		...
		myKey122.code = 123;
		myKey122.label = "\u0972" ;//a as in apple
		...
		myKey123.code = 124;
		myKey123.label = "\u0911" ;//o as in orange
		...
		myKey129 .code = 130;
		myKey129 .label = "\u0970" ;//Devanagari abbreviation sign
		...
		myKey130 .code = 131;
		myKey130 .label = "\u096A" ;//Devanagari digit four repeated from key 62
		...
		myKey135.customChakraLayout = new String[] {"\u090b","\u0944", "\u0960", "\u0901", "\u0946", "\u094a", "\u093d","\u0972", "\u0949", "\u0911"} ;
